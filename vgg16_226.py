# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 12:29:24 2024
...
#epochs=10
history=vgg_model.fit(x_train, y_train_one_hot, epochs=50, validation_data = (x_test, y_test_one_hot))

import pickle

with open('C:/caar/College/AI/Ensemble/Saved/vgg16226.pkl', 'wb') as model_file:pickle.dump(history, model_file)

vgg_model.save('C:/caar/College/AI/Ensemble/Saved/vgg_model1.hdf5')
vgg_model.save('C:/caar/College/AI/Ensemble/Saved/vgg_model2.keras')
