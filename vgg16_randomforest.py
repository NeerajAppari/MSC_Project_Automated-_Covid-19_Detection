# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 09:46:53 2024
...
with open('C:/caar/College/AI/Pretrained/VGG+RandomForest/Saved/vgg16_randomforest.pkl', 'wb') as model_file:pickle.dump(RF_model, model_file)
...
prediction_RF = RF_model.predict(X_test_features) #Inverse le transform to get original label back. 
...
cm = confusion_matrix(test_labels, prediction_RF) #print(cm)
