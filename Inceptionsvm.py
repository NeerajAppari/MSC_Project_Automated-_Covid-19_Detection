# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 22:47:47 2024
...
for layer in InceptionV3_model.layers: layer.trainable = False

InceptionV3_model.summary() #Trainable parameters will be 0
...
feature_extractor=InceptionV3_model.predict(x_train)
...
with open('C:/caar/College/AI/Pretrained/Inceptionv3+SVM/saved/svm_inceptionv3.pkl', 'wb') as model_file:pickle.dump(SVM_model, model_file)


#Send test data through same feature extractor process 
X_test_feature = InceptionV3_model.predict(x_test)
 
X_test_features = X_test_feature.reshape(X_test_feature.shape[0], -1)


#Now predict using the trained RF model. 
prediction_SVM = SVM_model.predict(X_test_feature) #Inverse le transform to get original label back. 
...
cm = confusion_matrix(test_labels, prediction_SVM) #print(cm)
...
input_img_feature=InceptionV3_model.predict(input_img)
